...
const CELL_JOIN_COLUMNS = `
  CAST(r.evaluation_id AS VARCHAR) AS evaluation_id,
  CAST(r.metric_summary_id AS VARCHAR) AS metric_summary_id,
  CAST(r.composite_slug AS VARCHAR) AS composite_slug,
  CAST(r.composite_display_name AS VARCHAR) AS composite_display_name,
  CAST(r.benchmark_id AS VARCHAR) AS benchmark_id,
  CAST(r.family_id AS VARCHAR) AS family_id,
  CAST(r.family_display_name AS VARCHAR) AS family_display_name,
  CAST(r.is_slice AS BOOLEAN) AS is_slice,
  CAST(r.parent_benchmark_id AS VARCHAR) AS parent_benchmark_id,
  CAST(r.metric_id AS VARCHAR) AS metric_id,
  CAST(r.model_key AS VARCHAR) AS model_key,
  CAST(r.model_id AS VARCHAR) AS model_id,
  CAST(r.model_route_id AS VARCHAR) AS model_route_id,
  CAST(to_json(r.model_info) AS VARCHAR) AS model_info,
  CAST(to_json(r.generation_config) AS VARCHAR) AS generation_config,
  CAST(r.metric_display_name AS VARCHAR) AS metric_display_name,
  CAST(r.metric_unit AS VARCHAR) AS metric_unit,
  CAST(r.lower_is_better AS BOOLEAN) AS lower_is_better,
  ...
  CAST(r.source_record_url AS VARCHAR) AS source_record_url,
  CAST(r.is_summary_score AS BOOLEAN) AS is_summary_score,
  ...
  CAST(r.instance_file_path AS VARCHAR) AS instance_file_path,
  CAST(e.evaluation_name AS VARCHAR) AS eval_evaluation_name,
  CAST(e.canonical_display_name AS VARCHAR) AS eval_canonical_display_name,
  CAST(e.benchmark_id AS VARCHAR) AS eval_benchmark_id,
  CAST(e.composite_slug AS VARCHAR) AS eval_composite_slug,
  CAST(e.composite_display_name AS VARCHAR) AS eval_composite_display_name,
  CAST(e.family_id AS VARCHAR) AS eval_family_id,
  CAST(e.family_display_name AS VARCHAR) AS eval_family_display_name,
  CAST(e.is_slice AS BOOLEAN) AS eval_is_slice,
  CAST(e.parent_benchmark_id AS VARCHAR) AS eval_parent_benchmark_id,
  CAST(e.composite_slug AS VARCHAR) AS eval_composite_benchmark_key,
  CAST(e.composite_display_name AS VARCHAR) AS eval_composite_benchmark_name,
  CAST(e.family_display_name AS VARCHAR) AS eval_benchmark_family_name,
  CAST(e.category AS VARCHAR) AS eval_category,
  ...
  CAST(e.is_summary_score AS BOOLEAN) AS eval_is_summary_score,
  CAST(to_json(e.summary_eval_ids) AS VARCHAR) AS eval_summary_eval_ids
`
