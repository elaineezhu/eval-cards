...
5. **Switch to Researcher View.** The toggle in the bar at the top of the page swaps Summary for Researcher view, which exposes the underlying per-result detail. Summary is for orientation; Researcher is for digging in.
